...
@implementation Song 
@synthesize songID, songName, artistName, albumName, albumArtID, songDuration, songData;
-(void)encodeWithCoder:(NSCoder *)encoder {
    ...
    [encoder encodeObject:albumArtID forKey:@"songAlbumArt"];
...
-(id)initWithCoder:(NSCoder *)decoder{
    ...
    self.albumArtID = [decoder decodeObjectForKey:@"songAlbumArt"];
...
- (id)copyWithZone:(NSZone *)zone{
    ...
    if (copy) {
        ...
        [copy setAlbumArtID:[self.albumArtID copyWithZone:zone]];
